<template>
  <div class="home">
    ...
    <SocialMediaCard class="social-media-card--facebook">
      ...
      <template v-slot:followers-count>
        1987
      </template>
      ...
      <template v-slot:today>
        <div class="social-media-card__amount--positive">
          <p>12 Today</p>
        </div>
      </template>
    </SocialMediaCard>

    <SocialMediaCard class="social-media-card--twitter">
      <template v-slot:svg>
    ...
    <SocialMediaCard class="social-media-card--instagram">
      <template v-slot:svg>
    ...
    <SocialMediaCard class="social-media-card--youTube">
      <template v-slot:svg>
      ...
      <template v-slot:today>
        <div class="social-media-card__amount--negative">
          <p>144 Today</p>
        </div>
      </template>
    </SocialMediaCard>
